...
function loadData(aData, orderBy) {
    var sHtml = ``;
    ...
    $('#products').html(sHtml);
    pagination(aData.current_page, aData.pages, aData.next_num, aData.prev_num, orderBy);
}


function pagination(current_page, pages, next_num, prev_num, orderBy) {
    if (prev_num == null) {
        var sHtml = `
<ul class="pagination">
...
<ul class="pagination">
    <li class="page-item">
    <a class="page-link" tabindex="-1" onclick="change(`+ prev_num + `, '` + orderBy + `')">Previous</a>
    </li>
`;
    }
    ...
    if (pages <= 6) {
        ...
        `;
                ...
                sHtml += `
        <li class="page-item no"><a class="page-link" onclick="change(`+ i + `, '` + orderBy + `')">` + i + `</a></li>
        `;
        }
    }
    else {
        ...
        if (current_page > 2) {
            sHtml += `<li class="page-item"><a class="page-link" onclick="change(1, '` + orderBy + `')">1</a></li>`;
            if (current_page > 3)
        ...
        for (var p = pageCutLow; p <= pageCutHigh; p++) {
            ...
            sHtml += `<li class="page-item ` + active + `"><a class="page-link" onclick="change(` + p + `, '` + orderBy + `')">` + p + `</a></li>`;
        }
        ...
        if (current_page < pages - 1) {
            ...
            sHtml += `<li class="page-item"><a class="page-link" onclick="change(` + pages + `, '` + orderBy + `')">` + pages + `</a></li>`;
        }
    }
    ...
    if (next_num == null) {
        sHtml += `
    <li class="page-item disabled">
    <a class="page-link" onclick="change(`+ next_num + `, '` + orderBy + `')">Next</a>
    </li></ul>
    `;
    } else {
        sHtml += `
    <li class="page-item">
    <a class="page-link" tabindex="-1" onclick="change(`+ next_num + `, '` + orderBy + `')">Next</a>
    </li></ul>
    `;
    }
